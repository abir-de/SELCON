...
files = ['results/Whole_server/cadata/combined_cadata_0.3_all_frac.xlsx',\
    'results/Whole_server/LawSchool/combined_LawSchool_0.04_all_frac.xlsx',\
    'results/Whole_server/MSD_no_full/combined_MSD_0.7_all_frac.xlsx']
...
good_labels = ["Random with Constraints","Ours","Random","Full with Constraints","Full",\
    "Facility with Constraints","Facility","Glister"]
...
file = "results/Images/Acc_vs_S/combine.pdf"#".pdf"
plt.savefig(file, bbox_inches='tight')
